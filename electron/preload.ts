...
contextBridge.exposeInMainWorld('api', {
    ...
    replaceDocument: (connId: string, dbId: string, contId: string, doc: any, pk?: any) => ipcRenderer.invoke('cosmos:replaceDocument', connId, dbId, contId, doc, pk),
    deleteDocument: (connId: string, dbId: string, contId: string, docId: string, pk?: any) => ipcRenderer.invoke('cosmos:deleteDocument', connId, dbId, contId, docId, pk),
