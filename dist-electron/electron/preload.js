...
electron_1.contextBridge.exposeInMainWorld('api', {
    ...
    replaceDocument: (connId, dbId, contId, doc, pk) => electron_1.ipcRenderer.invoke('cosmos:replaceDocument', connId, dbId, contId, doc, pk),
    deleteDocument: (connId, dbId, contId, docId, pk) => electron_1.ipcRenderer.invoke('cosmos:deleteDocument', connId, dbId, contId, docId, pk),
